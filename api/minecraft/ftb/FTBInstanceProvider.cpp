...
#include "ftb/LegacyFTBInstance.h"
...
void FTBInstanceProvider::loadInstances(SettingsObjectPtr globalSettings, QMap<QString, QString> &groupMap, QList<InstancePtr> &tempList)
{
...
void FTBInstanceProvider::initialize(SettingsObjectPtr globalSettings)
{
	// FTB
