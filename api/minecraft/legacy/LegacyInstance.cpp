...
#include "legacy/LegacyUpdate.h"
#include "legacy/LegacyModList.h"
#include "ModList.h"
#include "WorldList.h"
	...
	: MinecraftInstance(globalSettings, settings, rootDir)
{
	 ...
	 * [.]bin/mcbackup.jar is the default base jar
	 */
...
QString LegacyInstance::createLaunchScript(std::shared_ptr<Minecraft::AuthSession> session)
{
...
std::shared_ptr<LaunchStep> LegacyInstance::createMainLaunchStep(LaunchTask * parent, std::shared_ptr<Minecraft::AuthSession> session)
{
...
QStringList LegacyInstance::verboseDescription()
{
	QStringList out;
...
QStringList LegacyInstance::processMinecraftArgs(std::shared_ptr<Minecraft::AuthSession> account) const
{
	QStringList out;
