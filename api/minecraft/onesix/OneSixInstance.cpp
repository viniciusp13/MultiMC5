...
#include <QDebug>
#include "launch/DirectJavaLaunch.h"
...
QStringList OneSixInstance::processMinecraftArgs(std::shared_ptr<Minecraft::AuthSession> session) const
{
...
QString OneSixInstance::createLaunchScript(std::shared_ptr<Minecraft::AuthSession> session)
{
...
QStringList OneSixInstance::verboseDescription()
{
	QStringList out;
...
std::shared_ptr<LaunchStep> OneSixInstance::createMainLaunchStep(LaunchTask * parent, std::shared_ptr<Minecraft::AuthSession> session)
{
